			...
			<table class="qrcTable" border="0" cellpadding="0" cellpadding="0">
				<tr id="tr0" class="qrcTr">
					...
					<td id="td0b" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_FirstName" runat="server" ToolTip="enter first name" MaxLength="84" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged" Text="Heinrich" Width="84pt" Height="24pt" CssClass="QRTextBoxLeft"></asp:TextBox>
					</td>
					<td id="td0c" class="qrcTdRight" width="25%" height="30pt">last name:</td>
					<td id="td0d" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_LastName" runat="server" ToolTip="enter last name" MaxLength="84" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged" Text="Elsigan" Width="84pt" Height="24pt" CssClass="QRTextBoxRight"></asp:TextBox>
					</td>
				</tr>
				<tr id="tr1" class="qrcTr">
					...
					<td id="td1b" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_Phone" runat="server" ToolTip="enter phone number" MaxLength="84" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged"  Width="84pt" Height="24pt" CssClass="QRTextBoxLeft"></asp:TextBox>
					</td>
					<td id="td1c" class="qrcTdRight" width="25%" height="30pt">mobile:</td>
					<td id="td1d" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_Mobile" runat="server" ToolTip="enter mobile phone number" MaxLength="84" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged"  Width="84pt" Height="24pt" CssClass="QRTextBoxRight">+436507527928</asp:TextBox>
					</td>
				</tr>
				<tr id="tr2" class="qrcTr">
					...
					<td id="td2b" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_Email" runat="server" ToolTip="enter email address" MaxLength="128" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged"  Width="108pt" Height="24pt" CssClass="QRTextBox">office.area23@gmail.com</asp:TextBox>
					</td>
					<td id="td2c" class="qrcTdRight" width="25%" height="30pt">www:</td>
					<td id="td2d" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_Web" runat="server" ToolTip="enter www web site" MaxLength="128" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged"  Width="108pt" Height="24pt" CssClass="QRTextBox">https://area23.at/</asp:TextBox>
					</td>
				</tr>				
				<tr id="tr3" class="qrcTr">
					...
					<td id="td3b" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_Coutry" runat="server" ToolTip="Enter country here" MaxLength="84" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged"  Width="84pt" Height="24pt" CssClass="ButtonTextBox">Austria</asp:TextBox>
					</td>
				...
				<tr id="tr4" class="qrcTr">
					...
					<td id="td4b" class="qrcTdLeft" width="25%" height="30pt">
						<asp:TextBox ID="TextBox_City" runat="server" ToolTip="Enter city name" MaxLength="84" AutoPostBack="True" OnTextChanged="QRCode_ParameterChanged"  Width="84pt" Height="24pt" CssClass="QRTextBoxLeft">Vienna</asp:TextBox>
					</td>
