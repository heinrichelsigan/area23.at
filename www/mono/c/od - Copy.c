...
const char* sslprivkeycmd = "openssl rsa -in ktor.pk8 -pubout | tee ktor.spki ";
...
int exeCmd(char* cmdStr)
{
	...
	printf("\t\t\t<span style=\"width:22%; font-size: larger; text-align: left;\"><input type=\"submit\" name=\"Button_RsaKeyGen\" value=\"rsa key gen\" id=\"Button_RsaKeyGen\" title=\"Click to generate rsa  key pair.\" /></span>\n");
	...
	printf("\t\t\t<span class=\"smallSpan\" style=\"width:74%; text-align: right;\"><span class=\"textSpan\">rsa key gen: </span><input type=\"text\" value=\"%s\" maxlength=\"128\" readonly=\"ReadOnly\" name=\"TextBox_RsaCmd\" id=\"TextBox_RsaCmd\" title=\"rsa shell command\" class=\"ButtonTextBox\" style=\"height:24pt; width:68%;\" /></span>\n", odcmd);
	
	printf("\t\t\t</div>\n");
	printf("\t\t\t<hr />\n\t\t\t");
	printf("<pre id=\"odraw\"  name=\"odraw\" style=\"border-color: #1f3fef ;border-width: 1px; border-style:Solid; scroll-behavior: smooth; scrollbar-width: auto; background-color: #efcfaf; width:520px;\">");		
	...
	printf("\t\t\t<div align=\"left\" class=\"footerDiv\"><span style=\"width:12%; text-align: left;\" align=\"left\" valign=\"middle\"><a href=\"/cgi/fortune.cgi\">fortune</a></span>");
	
	printf("<span style=\"width:12%; text-align: center;\" align=\"center\" valign=\"middle\"><a href=\"/net/\">.net c# demo apache2 mod_mono</a></span>");	

	printf("<span style=\"width:12%; text-align: center;\" align=\"center\" valign=\"middle\"><a href=\"/cgi/od.cgi\">octal dump</a></span>");
	
	printf("<span style=\"width:64%; text-align: right;\" align=\"right\" valign=\"middle\"><a href=\"mailto:he@area23.at\">Heinrich Elsigan</a>, GNU General Public License 2.0, [<a href=\"https://blog.area23.at\">blog.</a>]<a href=\"https://area23.at\">area23.at</a></span></div>\n");
	printf("\t</form>\n");
	printf("\t</body>\n\n</html>\n");
...
int main(int argc, char** argv)
{
	...
	{
		sprintf(rsacmd, "/usr/local/bin/reakey.sh %d ", hexwidth);
	
		sprintf(odcmd, 
			"openssl genpkey -algorithm rsa -pkeyopt rsa_keygen_bits:%d > ktor.pk8 ; %s", 
