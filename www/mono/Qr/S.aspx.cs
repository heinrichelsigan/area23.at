...
namespace Area23.At.Mono.Qr
{
    public partial class S : QrBase
    {
        ...
        internal String ShortUrl { get => (Request.RawUrl.Contains("app.publish")) ? Constants.URL_SHORT_PREFIX_MONO : Constants.URL_SHORT_PREFIX_NET + hashKey; }
        ...
        protected virtual string ShortenUri(Uri longUri)
        {
            ...
            if (longUri != null)
            {
                ...
                Framework.Library.Static.JsonHelper.ShortenMapJson = shortenMap;
            }
