		...
		<div id="DivOuter" runat="server" style="border-width: 1px; border-style: double;">
			<table class="rpnTbl" border="0" cellpadding="0" cellspacing="0">
				<tr id="trA" class="rpnTr">
					...
					<td id="tdAb" width="60%" align="center" colspan="5" class="rpnTd"><asp:TextBox ID="TextBox_Calc" runat="server"  TextMode="SingleLine" ReadOnly="true" Columns="48" Font-Names="Courier New" /></td>
