...
<asp:Content ID="ContentEncodeHead" ContentPlaceHolderID="EncodeHead" runat="server">
	...
	<script type="text/javascript">
        ...
        function frogLoad() {
            ...
            if (headerImg != null) {
                document.getElementById("headerImg").src = "../res/gamez/froga/headerb.png";
        ...
        function moveFrog(jumpDirection) {
            ...
            if (jumpDirection.charAt(0) == 'u') {
                ...
                nrY = below(frY);												// down 				
                document.getElementById("aDown").src = "../res/gamez/froga/a_down.gif";
            }
    ...
    <div class="froga" align="center">
	    <div class="frogaHeader">
		    ...
		    <span id="headerCenter" align="center" valign="middle">
			    <img class="headerImage" src="../res/gamez/froga/headerb.png" id="headerImg" border="0" onclick="restart()" />
		    </span>
