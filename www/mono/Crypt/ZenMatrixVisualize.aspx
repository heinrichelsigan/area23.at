            ...
            <div class="odDiv">
                ...
                <span class="centerSpan" style="width: 72px;">                    
                    <asp:DropDownList ID="DropDownList_Cipher" runat="server" Enabled="false" style="width: 72px;">
                        <asp:ListItem Enabled="false" Value="Aes" Selected="false">Aes</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="BlowFish" Selected="false">BlowFish</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Fish2" Selected="false">Fish2</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Fish3" Selected="false">Fish3</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Camellia" Selected="false">Camellia</asp:ListItem>              
                        <asp:ListItem Enabled="false" Value="Cast5" Selected="False">Cast5</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Cast6" Selected="False">Cast6</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Des3" Selected="False">Des3</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Gost28147" Selected="False">Gost28147</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Idea" Selected="false">Idea</asp:ListItem>                        
                        <asp:ListItem Enabled="false" Value="Noekeon" Selected="false">Noekeon</asp:ListItem>                        
                        <asp:ListItem Enabled="false" Value="RC2" Selected="false">RC2</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="RC532" Selected="false">RC532</asp:ListItem>                
                        <asp:ListItem Enabled="false" Value="RC6" Selected="false">RC6</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Rijndael" Selected="false">Rijndael</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Rsa" Selected="false">Rsa</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Seed" Selected="false">Seed</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Serpent" Selected="false">Serpent</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="SkipJack" Selected="false">SkipJack</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Tea" Selected="false">Tea</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="Tnepres" Selected="false">Tnepres</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="XTea" Selected="false">XTea</asp:ListItem>
                        <asp:ListItem Enabled="false" Value="ZenMatrix" Selected="true">ZenMatrix</asp:ListItem>
                    </asp:DropDownList>
                </span>
                <span class="centerSpan" style="width: 72px;"> 
