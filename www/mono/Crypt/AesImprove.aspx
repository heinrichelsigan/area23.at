    ...
    <form id="AesImproveForm" runat="server" method="post" enableviewstate="True" enctype="multipart/form-data" submitdisabledcontrols="True" style="background-color: transparent;">
        <div style="background-color: transparent; padding-left: 40px; margin-left: 2px;">
            ...
            <div class="odDiv">
                ...
                <span class="rightSpan" style="width: 72px">
                    <asp:Button ID="Button_Reset_KeyIV" runat="server" ClientIDMode="Static"  Text="reset" 
        ...
        <div id="DivAesImprove" runat="server" style="padding-left: 40px; margin-left: 2px; background-image: url('../res/img/AesImproveBG.gif'); background-repeat: no-repeat; background-color: transparent;">
            ...
            <div class="odDiv">
                ...
                <span class="centerSpan" style="width: 72px;">                    
                    <asp:DropDownList ID="DropDownList_Cipher" runat="server" ClientIDMode="Static" style="width: 72px; z-index: 240;">
                        ...
                        <asp:ListItem Enabled="false" Value="Des" Selected="False">Des</asp:ListItem>
                        ...
                        <asp:ListItem Enabled="false" Value="RC564" Selected="false">RC564</asp:ListItem> 
                        ...
                        <asp:ListItem Enabled="false" Value="ZenMatrix2" Selected="false">ZenMatrix2</asp:ListItem>
                    </asp:DropDownList>
                </span>
                <span class="centerSpan" style="width: 72px;"> 
            ...
            <div id="DivCrypTextArea" class="CryptTextArea">                    
                <asp:TextBox ID="TextBoxSource" runat="server" ClientIDMode="Static" TextMode="MultiLine" MaxLength="65536" Rows="10" Columns="64" ValidateRequestMode="Disabled" ToolTip="[Enter text to en-/decrypt here]" Text="" Width="512px" CssClass="CryptTextArea"></asp:TextBox>
                <asp:TextBox ID="TextBoxDestionation" runat="server" ClientIDMode="Static" TextMode="MultiLine" Rows="10" Columns="64" MaxLength="65536" ReadOnly="true" ToolTip="Destination Text"  Width="512px" CssClass="CryptTextArea"></asp:TextBox>
                <br />
