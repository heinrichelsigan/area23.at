        ...
        <div style="background-color: transparent; padding-left: 40px; margin-left: 2px;">
            <div class="odDiv">
                ...
                <span class="rightSpan" style="width: 68px; min-width: 48px; max-width: 72px">
                    <asp:DropDownList ID="DropDownList_CipherMode" runat="server" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_CipherMode_SelectedIndexChanged">
                        ...
                        <asp:ListItem Enabled="true" Value="GOFB" Selected="false">GOFB</asp:ListItem>
                    </asp:DropDownList>
            ...
            <div class="odDiv" style="margin-top: 4px;">
                <span class="leftSpan" style="white-space: nowrap; width:92%; text-align: left;">
                    <uc23:HashKeyRadioButtonList ID="RadioButtonList_Hash"  ClientIDMode="Static" runat="server" OnParameterChanged_FireUp="HashKeyRadioButtonList_ParameterChanged" />                  
                </span>                
        ...
        <div id="DivCryptImprove" runat="server" ClientIDMode="Static" tyle="padding-left: 40px; margin-left: 2px; background-image: url('../res/img/crypt/AesImproveBG.gif'); background-repeat: no-repeat; background-color: transparent;">
            ...
            <div class="odDiv">
                <span class="leftSpan" style="width: 72px;">                      
                    <asp:DropDownList ID="DropDownList_Zip" runat="server" ClientIDMode="Static" AutoPostBack="true"
                        OnSelectedIndexChanged="DropDownList_Zip_SelectedIndexChanged" style="width: 64px; z-index: 100;">
                ...
                <span class="rightSpan">
                    &rArr; <asp:DropDownList ID="DropDownList_Encoding" runat="server" ClientIDMode="Static" AutoPostBack="true" 
                        ...
                        <asp:ListItem Enabled="true" Value="Ascii85" Selected="false">Ascii85</asp:ListItem>
                    </asp:DropDownList>
                </span>
            </div>
