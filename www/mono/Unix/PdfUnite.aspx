<%@ Page Title="MergePdf (apache2 mod_mono)" Language="C#" MasterPageFile="~/Unix/UnixMaster.master" AutoEventWireup="true" CodeBehind="PdfUnite.aspx.cs" Inherits="Area23.At.Mono.Unix.PdfUnite" %>
...
<asp:Content ID="UnixBodyContent" ContentPlaceHolderID="UnixBody" ClientIDMode="Static" runat="server">
    <form id="PdfUniteForm" runat="server">
            ...
            <table>
                <tr>
                    <td rowspan="4">
                        ...
                        OnSelectedIndexChanged="ListBoxFilesUploaded_SelectedIndexChanged"  AutoPostBack="true"  Rows="8" Height="192px" Width="480px" />
                    </td>
                    <td>
