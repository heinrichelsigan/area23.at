<%@ Page Language="C#" Title="hex dump (apache2 mod_mono)" MasterPageFile="~/Unix/UnixMaster.master" AutoEventWireup="true" CodeBehind="OctalDump.aspx.cs" Inherits="Area23.At.Mono.Unix.OctalDump" %>
    ...
    <form id="Area23UnixOctalDump" runat="server">
        ...
        <div class="odDiv">
            <span style="width:28%; text-align: left;">
                <asp:Button ID="Button_OctalDump" runat="server" ToolTip="Click to perform hex dump" Text="hex dump" OnClick="Button_OctalDump_Click" />
            </span>
