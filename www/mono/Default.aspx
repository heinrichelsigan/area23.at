...
<pre style="background-color: seashell; margin: 12px 12px 4px 4px; padding: 2px 2px 2px 2px; font-size: x-large">
...
│
├── <span style="color: blue; font-size: x-large">qr</span>
...
│
├── <span style="color: blue; font-size: x-large">crypt</span>
...
│
├── <span style="color: blue; font-size: x-large">calc</span>
...
│
└── <span style="color: blue; font-size: x-large">gamez</span>
