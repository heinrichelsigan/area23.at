<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CacheTest.aspx.cs" Inherits="Area23.At.Mono.Settings.CacheTest" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <hr />
            <div>
                <asp:Table ID="TableSettings" runat="server" ClientIDMode="Static" BorderStyle="Outset" BorderColor="#c0c0c0" CellPadding="1" CellSpacing="1">
                    <asp:TableHeaderRow>
