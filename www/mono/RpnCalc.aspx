		...
		<div class="rpnDiv" align="center">
			...
			<table class="rpnTbl" border="0" cellpadding="0" cellspacing="0">												
				...
				<tr id="tr7" class="rpnTr">
					...
					<td class="gainsboroTd" width="10%" id="td7b" align="center"><asp:Button ID="Blog" runat="server" ClientIDMode="Static" Text="log" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td7c" align="center"><asp:Button ID="Bln" runat="server" ClientIDMode="Static" Text="ln" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td7d" align="center"><asp:Button ID="Bld" runat="server" ClientIDMode="Static" Text="ld" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td7e" align="center"><asp:Button ID="Binverse" runat="server" ClientIDMode="Static" Text="1/x" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td7f" align="center"><asp:Button ID="Bmod" runat="server" ClientIDMode="Static" Text="mod" OnClick="bMath2Op_Click" /></td>
                    <td class="gainsboroTd" width="10%" id="td7g" align="center"><asp:Button ID="Babs" runat="server" ClientIDMode="Static" Text="|x|" AccessKey="|" OnClick="bMath_Click" /></td>
					<td class="rpnTd" width="10%" id="td7h"></td>
				</tr>
				<tr id="tr6" class="rpnTr">
					<td class="rpnTd" width="10%" id="td6a" runat="server" align="center"></td>
					<td class="gainsboroTd" width="10%" id="td6b" align="center"><asp:Button ID="Bsqrt" runat="server" ClientIDMode="Static" Text="√" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td6c" align="center"><asp:Button ID="Bsqr3" runat="server" ClientIDMode="Static" Text="∛" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td6d" align="center"><asp:Button ID="Bsqr4" runat="server" ClientIDMode="Static" Text="∜" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td6e" align="center"><asp:Button ID="Bpercent" runat="server" ClientIDMode="Static" Text="%" OnClick="bMath_Click" /></td>
					<td class="gainsboroTd" width="10%" id="td6f" align="center"><asp:Button ID="Bpermille" runat="server" ClientIDMode="Static" Text="‰" OnClick="bMath_Click" /></td>
				...
				<tr id="tr2" class="rpnTr">
					...
					<td class="deeppinkTd" width="10%" id="td2f" align="center">
                        <asp:Button ID="Bplus" runat="server" Text="+" OnClick="bMath2Op_Click" /></td>
                    <td class="palevioletredTd" width="10%" id="td2g" align="center"><asp:Button ID="BEnter" ClientIDMode="Static" runat="server" Text="&#9166;" OnClick="bEnter_Click" /></td>
