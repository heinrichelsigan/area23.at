    ...
    <form id="form1" runat="server">
		<div align="left" class="contentDiv">
			<asp:LinkButton ID="LinkButton_UrlShorten" runat="server" CssClass="QrLinkButton" ToolTip="Enter url to shorten" 
				OnClick="LinkButton_UrlShorten_Click" Text="short url (with qr):" Style="display: inline-block;">short url (with qr):</asp:LinkButton>
			<asp:TextBox ID="TextBox_UrlLong" runat="server" ToolTip="enter url www web site" AutoPostBack="True" OnTextChanged="TextBox_UrlLong_TextChanged"
				Width="60%" Height="24pt" AutoCompleteType="Homepage" CssClass="QRTextBoxSmall" />			
		</div>
		<div align="left" class="contentDiv">
			<asp:LinkButton ID="LinkButton_UrlQr" runat="server" CssClass="QrLinkButton" ToolTip="generate smaller qr-code image from short url" 
				OnClick="LinkButton_UrlQr_Click" Text="generate short qr:" Style="display: inline-block;">generate short qr:</asp:LinkButton>
			<asp:TextBox ID="TextBox_UrlShort" runat="server" ToolTip="autogenerated short url" ReadOnly="True" 
