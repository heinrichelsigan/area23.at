namespace Area23.At.WinForm.SecureChat.Gui.Controls
{
    partial class LinkLabelsControl
    {
        /// <summary> 
        ...
        {
            GroupBoxLinkLabels = new GroupBox();
            ...
            GroupBoxLinkLabels.SuspendLayout();
            SuspendLayout();
            // 
            // GroupBoxLinkLabels
            // 
            GroupBoxLinkLabels.BackColor = SystemColors.ControlLightLight;
            GroupBoxLinkLabels.Controls.Add(LinkLabel8);
            GroupBoxLinkLabels.Controls.Add(LinkLabel7);
            GroupBoxLinkLabels.Controls.Add(LinkLabel6);
            GroupBoxLinkLabels.Controls.Add(LinkLabel5);
            GroupBoxLinkLabels.Controls.Add(LinkLabel4);
            GroupBoxLinkLabels.Controls.Add(LinkLabel3);
            GroupBoxLinkLabels.Controls.Add(LinkLabel2);
            GroupBoxLinkLabels.Controls.Add(LinkLabel1);
            GroupBoxLinkLabels.Font = new Font("Lucida Sans Unicode", 9F);
            GroupBoxLinkLabels.Location = new Point(0, 0);
            GroupBoxLinkLabels.Margin = new Padding(1);
            GroupBoxLinkLabels.Name = "GroupBoxLinkLabels";
            GroupBoxLinkLabels.Padding = new Padding(1);
            GroupBoxLinkLabels.Size = new Size(151, 213);
            GroupBoxLinkLabels.TabIndex = 81;
            GroupBoxLinkLabels.TabStop = false;
            GroupBoxLinkLabels.Text = "GroupBoxLinkLabels";
            // 
            // LinkLabel8
            // 
            ...
            Controls.Add(GroupBoxLinkLabels);
            Margin = new Padding(0);
            Name = "LinkLabelsControl";
            Size = new Size(153, 215);
            GroupBoxLinkLabels.ResumeLayout(false);
            GroupBoxLinkLabels.PerformLayout();
            ResumeLayout(false);
        }

        #endregion

        private GroupBox GroupBoxLinkLabels;
