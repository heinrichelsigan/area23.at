...
namespace Area23.At.WinForm.SecureChat.Gui.Forms
{
    ...
    public partial class SecureChat : BaseChatForm
    {
        ...
        private async void SecureChat_Load(object sender, EventArgs e)
        {
            ...
            if (Entities.Settings.Instance.MyContact != null && Entities.Settings.Instance.MyContact.ContactImage != null && !string.IsNullOrEmpty(Entities.Settings.Instance.MyContact.ContactImage.ImageBase64))
            {
        ...
        private void ButtonKey_Click(object sender, EventArgs e)
        {
            ...
            SrvMsg1 serverMessage = new SrvMsg1(myServerKey);
        ...
        private void MenuItemAttach_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK || result == DialogResult.Yes)
            {
                ...
                {
                    string md5 = Area23.At.Framework.Core.Crypt.Hash.MD5Sum.Hash(openFileDialog.FileName, true);
                    string sha256 = Area23.At.Framework.Core.Crypt.Hash.Sha256Sum.Hash(openFileDialog.FileName, true);
